...
# I've bootlegged a copy of Seth Hall's Domain TLD module in here. Someday I'll zeek package this up
# This only alert on new second level domains. By using Domain TLD, we can expand that concept much further.
